...
export default function Acceso() {
  ...
  const entrar = (e) => {
    ...
    // En producción: la autenticación, los roles (Bombero, Oficial,
    // Administrador) y las rutas protegidas se resuelven en el backend (JWT).
    setAviso('Validando credenciales con el servidor…')
  }
    ...
    <section className="acceso">
      <div className="acceso__panel">
        ...
        <p className="acceso__roles">
          Roles del sistema: Bombero · Oficial · Administrador
        </p>
