...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------
   Cursos que abren los oficiales (tenientes, capitán, directora)
   para que los bomberos se inscriban. Funcionan como una encuesta:
   mientras hay cupos libres, solo se ve el CONTADOR (ej. 2/4), sin
   nombres. Al llenarse los cupos, el curso se cierra y se revela la
   lista de inscritos. Los oficiales siempre ven la lista.

   Campos:
     - id, nombre del curso, fechas (texto libre), descripción.
     - creadorRangoId: rango de quien lo creó (se detecta por sesión).
     - cupos: máximo de inscritos.
     - inscritos: lista de nombres anotados.
   ------------------------------------------------------------ */
export const cursos = [
  {
    id: 'curso-1',
    nombre: 'Escala y Cuerdas',
    fechas: '18 al 19 de septiembre',
    descripcion: 'Cuartel Segunda Compañía · Se requiere nivel inicial.',
    creadorRangoId: 'teniente1',
    cupos: 4,
    inscritos: ['Diego Fuentes', 'Camila Vega'],
  },
  {
    id: 'curso-2',
    nombre: 'Manejo de Materiales Peligrosos (HazMat)',
    fechas: '25 al 27 de septiembre',
    descripcion: 'Campus Norte · Nivel intermedio. Cupos limitados.',
