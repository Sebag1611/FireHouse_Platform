"""
Django settings for Firehouse_platform_Backend project.
...
ROOT_URLCONF = 'Firehouse_platform_Backend.urls'
...
WSGI_APPLICATION = 'Firehouse_platform_Backend.wsgi.application'
