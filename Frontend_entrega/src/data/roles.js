...
export const PERMISOS = {
  ...
  VER_CURSOS: 'ver_cursos',              // ver los cursos (TODOS)
  INSCRIBIRSE_CURSO: 'inscribirse_curso', // anotarse a un curso (bomberos+)
  GESTIONAR_CURSOS: 'gestionar_cursos',  // crear/editar/eliminar (oficiales)
  VER_INSCRITOS_CURSO: 'ver_inscritos_curso', // ver anotados aunque esté abierto (oficiales)
...
export const NIVELES = {
  ...
  ADMIN: {
    ...
    permisos: [
      ...
      PERMISOS.GESTIONAR_CURSOS,
      PERMISOS.VER_INSCRITOS_CURSO,
