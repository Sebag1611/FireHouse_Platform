...
import { redes } from '../../../data/contenidoPublico'
 ...
 *
 * Incluye la marca, enlaces de navegación y contacto, y los
 * accesos a redes sociales (HU-01). Los enlaces de redes abren
 * en pestaña nueva con rel="noopener noreferrer" (buena práctica
 * de seguridad exigida por el criterio de aceptación de la HU-01).
 */

// Iconos de marca de las redes, definidos como SVG en línea.
const iconosRed = {
  instagram: (
...
export default function Footer() {
  return (
    <footer className="footer">
      {/* Cinta diagonal: firma visual de la marca. */}
      ...
      <div className="contenedor footer__grid">
        ...
        <div className="footer__col">
          ...
          <Link to={ROUTES.UNIDADES}>Material Mayor</Link>
          <Link to={ROUTES.NOTICIAS}>Noticias</Link>
          <Link to={ROUTES.CONTACTO}>Contacto</Link>
        </div>

        <div className="footer__col">
          <h4>Participa</h4>
          <Link to={ROUTES.POSTULAR}>Postular como voluntario</Link>
          <Link to={ROUTES.ACCESO}>Acceso interno</Link>
